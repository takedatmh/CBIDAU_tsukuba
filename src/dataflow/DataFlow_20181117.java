 ...
 *
 */
public class DataFlow_20181117{
...
//	    		"org.apache.struts.action.ActionServlet"}));
	    argsList.addAll(Arrays.asList(new String[] {"-w", "-main-class",
	    		"org.apache.catalina.manager.TestManagerServlet",
	    		"org.apache.catalina.manager.TestManagerServlet",
		...
		protected void internalTransform(String phaseName, @SuppressWarnings("rawtypes") Map options) {
			       ...
			       SootClass a = Scene.v().getSootClass("org.apache.catalina.manager.ManagerServlet");
	               ...
	               SootMethod method = a.getMethodByName("deploy");
...
//	               }
	               ...
	               ///////DFA//////////////////////
	               GuaranteedDefsAnalysis df = new GuaranteedDefsAnalysis(unitGraph);
	               GuaranteedDefs gf = new GuaranteedDefs(unitGraph);
	               Iterator<Unit> units2 = unitGraph.iterator(); 
	               PrintWriter pw = null;
	               try {
		               pw = new PrintWriter("DF"+"_"+"Tomcat_org.apache.catalina.manager.ManagerServlet_"+"deploy"+".txt");
	               ...
	               ///////Method Call Flow////////
	               //System.out.println("WORKFLOW: "+workflowsNames);
	               
	               ///////CG///////////////////////
//	   		       SootMethod src = Scene.v().getMainClass().getMethodByName("main");
//			       CallGraph cg = Scene.v().getCallGraph();
//	               SerializeCallGraph(cg, "CG_Tomcat_org.apache.catalina.manager.ManagerServlet" + DotGraph.DOT_EXTENSION);
			       
			       //draw CGF/////////////////////
			       SerializeControlFlowGraph(unitGraph, "CFG_Tomcat_org.apache.catalina.manager.ManagerServlet_"+"deploy" + DotGraph.DOT_EXTENSION);
