 ...
 *
 */
public class CFG_DF_20190816 {

	// Method Name
	private static String methodName = "delete";
...
//		}
		...
		// search
		Map<Integer, List<String>> map = searchPath2(graph, top, tails.get(0),
				todo, seen, visitNodeList, pathListMap, strUnitMap);
	 ...
	 * @return
	 */
	public static Map<Integer, List<String>> searchPath2(UnitGraph graph,
		...
		// 04-05まで実行してメソッドの中で0を呼び出す。
		Unit nextNode = methodNo4(graph, tail, todo, seen, visitNodeList,
				pathListMap, strUnitMap);
		
		// 5.2.1.2. 空でないならNextNodeを引数指定して０に戻る。
		searchPath2(graph, nextNode, tail, todo, seen, visitNodeList,
				pathListMap, strUnitMap);
	 ...
	 * @return
	 */
	public static Unit methodNo4(UnitGraph graph,
